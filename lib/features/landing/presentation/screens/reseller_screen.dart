...
class _ResellerScreenState extends State<ResellerScreen> {
        ...
        children: [
          Container(
            ...
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                const Icon(Icons.trending_up, size: 12, color: Color(0xFF374151)),
                const SizedBox(width: 4),
                Text('Reseller Mode', style: GoogleFonts.poppins(fontSize: 12, fontWeight: FontWeight.w500, color: const Color(0xFF374151))),
              ],
            ),
          ),
          ...
          Row(
            children: [
              ...
              Padding(
                ...
                child: Image.asset(
                  'assets/images/Resell.png',
                  width: 120,
                  height: 120,
                  fit: BoxFit.contain,
                  errorBuilder: (_, __, ___) => const Icon(Icons.sell_outlined, size: 60, color: Color(0xFF9747FF)),
                ),
              ),
            ],
          ),
  ...
  Widget _buildFeaturesSection() {
    final highlights = [
      {'icon': Icons.auto_awesome, 'text': 'Higher Margins', 'bg': const Color(0xFFEEF2FF)},
      {'icon': Icons.grid_view, 'text': 'Flexible Pricing', 'bg': const Color(0xFFFFF4E6)},
      {'icon': Icons.flash_on, 'text': 'Fast Processing', 'bg': const Color(0xFFE9FBF1)},
    ];
  ...
  Widget _buildHowItWorksSection() {
    final steps = [
      {'title': 'Register as Reseller', 'desc': 'Register your organization to access reseller pricing and create your account.', 'icon': Icons.person_add, 'color': const Color(0xFF7C3AED), 'hasAction': true},
      {'title': 'Login & Access Dashboard', 'desc': 'Login to your reseller dashboard to manage inventory and orders.', 'icon': Icons.login, 'color': const Color(0xFF4C42B8)},
      {'title': 'Select Vouchers & Denominations', 'desc': 'Choose brand vouchers and pick resale-friendly denomination values.', 'icon': Icons.tag, 'color': const Color(0xFF3B82F6)},
      {'title': 'Add to Cart & Fund Wallet', 'desc': 'Review your inventory selection and top up your SabbPe wallet.', 'icon': Icons.shopping_cart_outlined, 'color': const Color(0xFF7C3AED)},
      {'title': 'Receive Vouchers', 'desc': 'Instantly access vouchers in your dashboard after wallet funding.', 'icon': Icons.mark_email_read, 'color': const Color(0xFF3B82F6)},
      {'title': 'Start Selling', 'desc': 'Begin reselling vouchers on your platform and earn margins.', 'icon': Icons.trending_up, 'color': const Color(0xFFF97316)},
    ];
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 8),
          Text('Our team will contact you shortly regarding reseller onboarding.', style: GoogleFonts.poppins(fontSize: 14, color: Colors.grey[600]), textAlign: TextAlign.center),
          const SizedBox(height: 20),
          SizedBox(
            width: double.infinity,
