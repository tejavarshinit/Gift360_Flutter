...
class BlogScreen extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              decoration: const BoxDecoration(gradient: LinearGradient(colors: [Color(0x1A6C5CE7), Color(0x0AEF4444)])),
              child: const Column(
                children: [
            ...
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Row(children: [const Icon(Icons.local_fire_department, color: Colors.red, size: 28), const SizedBox(width: 8), const Text('Trending Updates', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold))]),
                  ...
                  Row(children: [const Icon(Icons.rocket_launch, color: Color(0xFF6C5CE7), size: 28), const SizedBox(width: 8), const Text('Upcoming Updates', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold))]),
                  const SizedBox(height: 12),
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Row(children: [const Icon(Icons.access_time, color: Colors.grey, size: 28), const SizedBox(width: 8), const Text('Site Changelogs', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold))]),
                        const SizedBox(height: 16),
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(children: [
                    Container(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 2), decoration: BoxDecoration(color: const Color(0xFF6C5CE7).withValues(alpha: 0.1), borderRadius: BorderRadius.circular(8)), child: Text(news['category']!, style: const TextStyle(fontSize: 10, color: Color(0xFF6C5CE7), fontWeight: FontWeight.w600))),
  ...
  Widget _buildUpdateCard(Map<String, dynamic> update) {
    return Container(
      ...
      child: Row(children: [
        Container(padding: const EdgeInsets.all(8), decoration: BoxDecoration(color: const Color(0x1A6C5CE7), borderRadius: BorderRadius.circular(8)), child: Icon(update['icon'] as IconData, color: const Color(0xFF6C5CE7), size: 20)),
        ...
        Expanded(child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 4),
            Container(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 2), decoration: BoxDecoration(color: const Color(0xFF6C5CE7).withValues(alpha: 0.1), borderRadius: BorderRadius.circular(8)), child: Text(update['status'] as String, style: const TextStyle(fontSize: 10, color: Color(0xFF6C5CE7), fontWeight: FontWeight.w600))),
          ],
        )),
      ]),
    );
  ...
  Widget _buildChangelog(Map<String, dynamic> log) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(children: [
            Container(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 2), decoration: BoxDecoration(color: Colors.grey.shade200, borderRadius: BorderRadius.circular(8)), child: Text(log['version'] as String, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600))),
            const SizedBox(width: 8),
          ...
          ...((log['changes'] as List<String>).map((c) => Padding(
            ...
            child: Row(children: [Container(width: 6, height: 6, decoration: const BoxDecoration(color: Color(0xFF6C5CE7), shape: BoxShape.circle)), const SizedBox(width: 8), Text(c, style: const TextStyle(fontSize: 13))]),
          ))),
        ],
      ),
    );
